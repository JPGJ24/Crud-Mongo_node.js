In this application create a basic Create, Read, Update and Delete app on a database or dataset. In a nutshell, the operation of a CRUD app involves the following:
